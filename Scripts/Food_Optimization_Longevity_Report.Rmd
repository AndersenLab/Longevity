...
```{r Raw data, warning = F, message = F, echo = F, fig.path = data.loc}
...
```{r Binned Data, warning = F, message = F, echo = F, fig.path = data.loc}
...
```{r Combined Data, warning = F, message = F, echo = F, fig.path = data.loc}
