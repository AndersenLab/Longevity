...
```{r Raw data, warning = F, message = F, echo = F, fig.path = paste("Scripts/", data.loc, sep = ""), fig.width = 15, fig.height = 12}
...
```{r Binned Data, warning = F, message = F, echo = F, fig.path = paste("Scripts/", data.loc, sep = ""), fig.width = 15, fig.height = 12}
...
```{r Combined Data, warning = F, message = F, echo = F, fig.path = paste("Scripts/", data.loc, sep = ""), fig.width = 15, fig.height = 12}
