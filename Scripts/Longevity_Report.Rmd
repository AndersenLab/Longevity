...
ggplot(heritabilities) + aes(x = factor(parameter), y = herit, color = grouping, size = 6) + geom_point() + labs(x = "Parameter", y = "Heritability") + ylim(0, 1) + presentation + guides(size = FALSE)
