...
for (x in 1:12) {
  for (y in 1:2) {
    well_fours_survivals.df[l] <- draw_twoplog(well_fours_params.df$Aparam[well_fours_params.df$col == x & well_fours_params.df$grouping == y], well_fours_params.df$Gparam[well_fours_params.df$col == x & well_fours_params.df$grouping == y])
    l <- l + 1
  }
}
