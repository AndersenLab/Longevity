...
data.loc <- paste("../Data/Raw/", alt, sep = "")
...
test.df <- data.frame(binSize = vector(length = nFiles),
...
for (i in 1:nFiles) {
  output[[i]] <- processMicrotrackerReport(files[i])
  test.df$binSize[i] = output[[i]]$binSize[1]
  test.df$time[i] = output[[i]]$time[1]
  test.df$numGroups[i] = output[[i]]$numGroups[1]
  test.df$numBins[i] = output[[i]]$numBins[1]
}

xhlhfds <- test.df %>% summarise_each(funs(n_distinct))

if (xhlhfds$binSize != 1 || xhlhfds$numGroups != 1) {
  stop("Not all wMicrotracker files have the same bin size or number of groups.")
}

minBins <- output[[1]]$numBins[1]

for (i in 2:length(output)) {
  minBins <- min(minBins, output[[i]]$numBins)
}

raw.df <- ldply(output, generateDataFrameFromFile) %>% filter(time <= minBins * 2) # need to check consistent binSize instead of 2
raw.df$day <- rep(1:(length(files)), each = nStrains * replicates * minBins)

save(raw.df, file = paste(data.loc, "/", experimentName, "_Raw2.Rda", sep = ""), ascii = TRUE)

data.df <- raw.df[order(raw.df$col, raw.df$row, raw.df$day), ]

data.df$strain <- factor(data.df$col, labels = strains)

save(data.df, file = paste(data.loc, "/", experimentName, "_Processed2.Rda", sep = ""), ascii = TRUE)

```

```{r Raw2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
save(cleaned.df, file = paste(data.loc, "/", experimentName, "_Cleaned2.Rda", sep = ""), ascii = TRUE)

```

```{r Cleaned2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
```{r Well_Mean2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
```{r Well_Median2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
```{r Well_Total2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
save(well.df, file = paste(data.loc, "/", experimentName, "_Well2.Rda", sep = ""), ascii = TRUE)

```

```{r Well_Normalized2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
```{r Well_Adjusted2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
save(well_params.df, file = paste(data.loc, "/", experimentName, "_Well_Params2.Rda", sep = ""), ascii = TRUE)
...
```{r Well_Fits2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
```{r Strain_Mean2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
```{r Strain_Median2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
```{r Strain_Total2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
```{r Strain_Normalized2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
```{r Strain_Adjusted2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
...
save(strain_params.df, file = paste(data.loc, "/", experimentName, "_Strain_Params2.Rda", sep = ""), ascii = TRUE)
...
```{r Strain_Fits2, warning = FALSE, message = FALSE, echo = FALSE, fig.path = paste("Scripts/", data.loc, "/", experimentName, "_", sep = ""), fig.width = 15, fig.height = 12}
